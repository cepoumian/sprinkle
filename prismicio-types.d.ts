...
/**
 * Item in *Bento → Default → Primary → Bento Item*
 */
export interface BentoSliceDefaultPrimaryBentoItemItem {
  /**
   * Title field in *Bento → Default → Primary → Bento Item*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_item[].title
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  title: prismic.RichTextField;

  /**
   * Body field in *Bento → Default → Primary → Bento Item*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_item[].body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Bento Item*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_item[].image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Bento Item*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.bento_item[].wide
   * - **Documentation**: https://prismic.io/docs/fields/boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Bento Item field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_item[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  bento_item: prismic.GroupField<
    Simplify<BentoSliceDefaultPrimaryBentoItemItem>
  >;
}
...
/**
 * Item in *Integrations → Default → Primary → Integrations Group*
 */
export interface IntegrationsSliceDefaultPrimaryIntegrationsGroupItem {
  /**
   * Icon field in *Integrations → Default → Primary → Integrations Group*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.integrations_group[].icon
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  icon: prismic.SelectField<
    "cloudflare" | "npm" | "github" | "figma" | "digital_ocean" | "fly"
  >;
}
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * Integrations Group field in *Integrations → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.integrations_group[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  integrations_group: prismic.GroupField<
    Simplify<IntegrationsSliceDefaultPrimaryIntegrationsGroupItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      IntegrationsSlice,
      IntegrationsSliceDefaultPrimaryIntegrationsGroupItem,
